...
# Spring 2021 - Data Structures - Lecture 25 - Grading Script
...
echo "-----------------------------" >> $SCRIPT_OUT
echo "" >> $SCRIPT_OUT
echo "Lec25 Grade: Earned $STUDENT_GRADE points today "
echo "Lec25 Grade: Earned $STUDENT_GRADE points today " >> $SCRIPT_OUT
