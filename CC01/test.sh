...
MAKE_CLEAN_EXPECTED="rm -rf *.o lucky streams combine"
...
MAKE_LUCKY_EXPECTED_FIRST="g++ -m64 -std=c++11 -Weffc++ -O2 -g -Wall -Wextra -Wconversion -Wshadow -pedantic -Werror -lm -c lucky.cpp"
MAKE_LUCKY_EXPECTED_SECOND="g++ -m64 -std=c++11 -Weffc++ -O2 -g -Wall -Wextra -Wconversion -Wshadow -pedantic -Werror -lm -o lucky lucky.o"
MAKE_LUCKY_RESULT=$( $MAKE_LUCKY )

# Delete redirect and send make result to redirect 

echo $MAKE_LUCKY_RESULT >> $REDIRECT

# Send results to the script
echo "Expected $MAKE_LUCKY output: $MAKE_LUCKY_EXPECTED_FIRST
$MAKE_LUCKY_EXPECTED_SECOND" >> $SCRIPT_OUT
echo "Actual $MAKE_LUCKY output  : $MAKE_LUCKY_RESULT" >> $SCRIPT_OUT
echo "" >> $SCRIPT_OUT

# Add points to overall score or mark as 0 if not for make lucky

if grep -q "$MAKE_LUCKY_EXPECTED_FIRST" $REDIRECT && grep -q "$MAKE_LUCKY_EXPECTED_SECOND" $REDIRECT
...
MAKE_STREAMS_EXPECTED_FIRST="g++ -m64 -std=c++11 -Weffc++ -O2 -g -Wall -Wextra -Wconversion -Wshadow -pedantic -Werror -lm -c streams.cpp"
MAKE_STREAMS_EXPECTED_SECOND="g++ -m64 -std=c++11 -Weffc++ -O2 -g -Wall -Wextra -Wconversion -Wshadow -pedantic -Werror -lm -o streams streams.o"

MAKE_STREAMS_RESULT=$( $MAKE_STREAMS )

# Send results to the script
echo "Expected $MAKE_STREAMS output: $MAKE_STREAMS_EXPECTED_FIRST
$MAKE_STREAMS_EXPECTED_SECOND" >> $SCRIPT_OUT
echo "Actual $MAKE_STREAMS output  : $MAKE_STREAMS_RESULT" >> $SCRIPT_OUT
echo "" >> $SCRIPT_OUT

echo $MAKE_STREAMS_RESULT >> $REDIRECT

# Add points to overall score or mark as 0 if not for make lucky
if grep -q "$MAKE_STREAMS_EXPECTED_FIRST" $REDIRECT && grep -q "$MAKE_STREAMS_EXPECTED_SECOND" $REDIRECT
...
MAKE_COMBINE_EXPECTED_FIRST="g++ -m64 -std=c++11 -Weffc++ -O2 -g -Wall -Wextra -Wconversion -Wshadow -pedantic -Werror -lm -c combine.cpp"
MAKE_COMBINE_EXPECTED_SECOND="g++ -m64 -std=c++11 -Weffc++ -O2 -g -Wall -Wextra -Wconversion -Wshadow -pedantic -Werror -lm -o combine combine.o"
MAKE_COMBINE_RESULT=$( $MAKE_COMBINE )

# Send results to the script
echo "Expected $MAKE_COMBINE output: $MAKE_COMBINE_EXPECTED_FIRST
$MAKE_COMBINE_EXPECTED_SECOND" >> $SCRIPT_OUT
echo "Actual $MAKE_COMBINE output  : $MAKE_COMBINE_RESULT" >> $SCRIPT_OUT
echo "" >> $SCRIPT_OUT

echo $MAKE_COMBINE_RESULT >> $REDIRECT

# Add points to overall score or mark as 0 if not for make lucky
if grep -q "$MAKE_COMBINE_EXPECTED_FIRST" $REDIRECT && grep -q "$MAKE_COMBINE_EXPECTED_SECOND" $REDIRECT
