...
# Spring 2021 - Data Structures - Lecture 18 - Grading Script
...
echo "-----------------------------" >> $SCRIPT_OUT
echo "" >> $SCRIPT_OUT
echo "Lec18 Grade: Earned $STUDENT_GRADE points today "
echo "Lec18 Grade: Earned $STUDENT_GRADE points today " >> $SCRIPT_OUT
