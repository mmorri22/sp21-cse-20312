...
# Spring 2021 - Data Structures - Lab 11 - Grading Script
...
echo "-----------------------------" >> $SCRIPT_OUT
echo "" >> $SCRIPT_OUT
echo "Lab11 Grade: Earned $STUDENT_GRADE points today "
echo "Lab11 Grade: Earned $STUDENT_GRADE points today " >> $SCRIPT_OUT
