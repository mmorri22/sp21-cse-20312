...
# Spring 2021 - Data Structures - Lecture 19 - Grading Script
...
echo "-----------------------------" >> $SCRIPT_OUT
echo "" >> $SCRIPT_OUT
echo "Lec19 Grade: Earned $STUDENT_GRADE points today "
echo "Lec19 Grade: Earned $STUDENT_GRADE points today " >> $SCRIPT_OUT
